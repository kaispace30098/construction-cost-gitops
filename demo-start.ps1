...
$bodyHigh = [PSCustomObject]@{
    Task_Duration_Days        = 45
    Labor_Required            = 15
    Equipment_Units           = 8
    Start_Constraint          = 3
    Risk_Level                = "High"
    Resource_Constraint_Score = 6
    Site_Constraint_Score     = 7
    Dependency_Count          = 4
...
$bodyLow = [PSCustomObject]@{
    Task_Duration_Days        = 5
    Labor_Required            = 2
    Equipment_Units           = 1
    Start_Constraint          = 0
    Risk_Level                = "Low"
    Resource_Constraint_Score = 1
    Site_Constraint_Score     = 1
    Dependency_Count          = 0
} | ConvertTo-Json -Compress
